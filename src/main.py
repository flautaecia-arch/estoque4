...
# Configuração do banco de dados com criação de diretório
db_dir = os.environ.get('DATABASE_DIR', '/opt/render/project/src/database')
...
with app.app_context():
    ...
    if Produto.query.count() == 0:
        from src.init_data import initialize_products
        initialize_products()
